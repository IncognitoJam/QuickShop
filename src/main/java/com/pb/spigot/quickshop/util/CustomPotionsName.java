...
public class CustomPotionsName {
    ...
    public static String getFullName(ItemStack potionItemStack) {
        ...
        type += (potion.getAmplifier() > 1 ? " " + potion.getAmplifier() : "") + (potion.getDuration() > 0 ? " (" + potion.getDuration() / 20 + "s)" : potion.getDuration() == -1 ? "+" : "");
    ...
    public static String getEffects(ItemStack potionItemStack) {
        ...
        for (PotionEffect potionEffect : potion.getEffects()) {
            ...
            sb.append(name.trim() + (potionEffect.getAmplifier() > 1 ? " " + potionEffect.getAmplifier() : "") + (potionEffect.getDuration() > 0 ? " (" + potionEffect.getDuration() / 20 + "s)" : potionEffect.getDuration() == -1 ? "+" : "") + " | ");
        }
